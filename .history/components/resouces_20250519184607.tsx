...
import { ExternalLink, BookOpen, Code, Palette, Component, Zap, Video, Tool, FileText } from "lucide-react";
...
export function ResourcesModal({ open, onOpenChange }: ResourcesModalProps) {
